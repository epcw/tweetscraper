...
pull=$(python3 /home/pzed/Dropbox/Github/tweetscraper/search-tweets-python/tools/search_tweets.py --max-results 100 --filter-rule "$3" --filename-prefix tweetscraper_$today_$1$2 --credential-file /home/pzed/Dropbox/Github/tweetscraper/search-tweets-python/tools/.twitter_keys_all.yaml --start-datetime ${1}T00:00 --end-datetime ${2}T00:00 --no-print-stream)
